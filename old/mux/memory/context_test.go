...
func TestRelativeTimeSeconds(t *testing.T) {
	got := RelativeTime(30 * time.Second)
	if got != "30s ago" {
...
func TestRelativeTimeMinutes(t *testing.T) {
	got := RelativeTime(5 * time.Minute)
	if got != "5m ago" {
...
func TestRelativeTimeDays(t *testing.T) {
	got := RelativeTime(36 * time.Hour) // 1.5 days
	if got != "1d ago" {
		t.Errorf("expected '1d ago', got %q", got)
	}
}

func TestRelativeTimeWeek(t *testing.T) {
	got := RelativeTime(7 * 24 * time.Hour)
	if got != "7d ago" {
...
func TestRelativeTimeMonths(t *testing.T) {
	got := RelativeTime(30 * 24 * time.Hour)
	if got != "1mo ago" {
		t.Errorf("expected '1mo ago', got %q", got)
	}
}

func TestRelativeTimeMultipleMonths(t *testing.T) {
	got := RelativeTime(90 * 24 * time.Hour)
	if got != "3mo ago" {
		t.Errorf("expected '3mo ago', got %q", got)
	}
}
...
func TestRelativeTimeZero(t *testing.T) {
	got := RelativeTime(0)
	if got != "0s ago" {
		t.Errorf("expected '0s ago', got %q", got)
	}
}

func TestRelativeTimeNegative(t *testing.T) {
