...
var ConfigKeys = []ConfigKey{
	...
	{Name: "openai_key", Path: "models.providers.openai.api_key", Type: "string", Desc: "OpenAI API key", Redacted: true, EnvVar: "OPENAI_API_KEY", Provider: "openai"},
	{Name: "anthropic_key", Path: "models.providers.anthropic.api_key", Type: "string", Desc: "Anthropic API key", Redacted: true, EnvVar: "ANTHROPIC_API_KEY", Provider: "anthropic"},
	{Name: "openrouter_key", Path: "models.providers.openrouter.api_key", Type: "string", Desc: "OpenRouter API key", Redacted: true, EnvVar: "OPENROUTER_API_KEY", Provider: "openrouter"},
